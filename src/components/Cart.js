                ...
                {step === 1 && (
                    <form onSubmit={handleNextStep}>
                        <div className="mb-4">
                            ...
                            <input type="text" id="name" name="name" value={formValues.name} onChange={handleFormChange} className="w-full px-2 rounded bg-gray-100" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="email" className="block font-medium mb-2">Email</label>
                            <input type="email" id="email" name="email" value={formValues.email} onChange={handleFormChange} className="w-full px-2 rounded bg-gray-100" required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="phone" className="block font-medium mb-2">Phone</label>
                            <input type="tel" id="phone" name="phone" value={formValues.phone} onChange={handleFormChange} className="w-full px-2 rounded bg-gray-100" required />
                        </div>
                ...
                {step === 2 && (
                    <form onSubmit={handleNextStep}>
                        <div className="mb-4">
                            ...
                            <textarea id="address" name="address" value={formValues.address} onChange={handleFormChange} className="w-full rounded bg-gray-100 px-2" required></textarea>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="landmark" className="block font-medium mb-2">Landmark</label>
                            <input type="text" id="landmark" name="landmark" value={formValues.landmark} onChange={handleFormChange} className="w-full rounded bg-gray-100 px-2" required />
                        </div>
                        <div className="flex mb-4">
                            <div className="flex-1 mr-4">
                                <label htmlFor="city" className="block font-medium mb-2">City</label>
                                <input type="text" id="city" name="city" value={formValues.city} onChange={handleFormChange} className="w-full rounded bg-gray-100 px-2" required />
                            </div>
                            <div className="flex-1">
                                <label htmlFor="state" className="block font-medium mb-2">State</label>
                                <input type="text" id="state" name="state" value={formValues.state} onChange={handleFormChange} className="w-full rounded bg-gray-100 px-2" required />
                            </div>
                        </div>
                        <div className="mb-4">
                            <label htmlFor="pincode" className="block font-medium mb-2">Pincode</label>
                            <input type="text" id="pincode" name="pincode" value={formValues.pincode} onChange={handleFormChange} className="w-full rounded bg-gray-100 px-2" required />
                        </div>
                        ...
                        {formValues.paymentMethod === 'credit-card' && (
                            <div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <input type="text" id="card-number" name="cardNumber" value={formValues.cardNumber} onChange={handleFormChange} className="w-full rounded px-2 bg-gray-100" required />
                                </div>
                                <div className="mb-4">
                                    <label htmlFor="expiry" className="block font-medium mb-2">Expiry Date</label>
                                    <div className="flex">
                                        <input type="text" id="expiry" name="expiry" value={formValues.expiry} onChange={handleFormChange} placeholder="MM / YY" className="w-full rounded px-2 bg-gray-100 mr-4" required />
                                        <input type="text" id="cvv" name="cvv" value={formValues.cvv} onChange={handleFormChange} placeholder="CVV" className="w-full rounded px-2 bg-gray-100" required />
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            <>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex">
                                        ...
                                        <button type="submit" className="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded">Place Order</button>
                                    </div>
                                </div>
                            </>)}
